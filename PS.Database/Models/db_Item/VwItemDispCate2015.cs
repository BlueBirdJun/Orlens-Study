...
{
    public partial class VwItemDispCate2015
    {
        public int Itemid { get; set; }
        public string Catecode { get; set; }
        public string CatecodeExt { get; set; }
        public short CateSortNo { get; set; }
        ...
        public string ReipgoDate { get; set; }
        ...
        public string Colorbasicimage { get; set; }
        public string Colorgrp { get; set; }
        public string Attribgrp { get; set; }
        public string Cd1sort { get; set; }
        public string Cd2sort { get; set; }
        public string Cd3sort { get; set; }
        public string Addimage { get; set; }
        public int Recentsellcount { get; set; }
        public string Pojangok { get; set; }
        public int Pojangcnt { get; set; }
        public int Totalpoint { get; set; }
        public int Optioncnt { get; set; }
        public int? Dealmasteritem { get; set; }
        public string Deliverfixday { get; set; }
        public string Bestkeylist { get; set; }
        public string Cateboostkeylist { get; set; }
        public string Basicimage600 { get; set; }
        public int? AdultType { get; set; }
        public int SellCnt { get; set; }
        public string Attriblist { get; set; }
        public string Subshoplist { get; set; }
        public string Giftdiv { get; set; }
        public string BestYn { get; set; }
